#!/bin/bash
# Task A 7B multi-turn GRPO launcher using native Swift RLHF training.
...
SWANLAB_PROJECT=${SWANLAB_PROJECT:-belief_training_task_a}
SWANLAB_EXP_NAME=${SWANLAB_EXP_NAME:-swift_grpo_7B_zero2}

LOGDIR=${LOGDIR:-task_a/outputs/multi_turn_online_swift_grpo_7B_logs}
