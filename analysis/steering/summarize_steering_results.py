...
from analysis.steering.common import read_json, write_json  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--input", type=Path, default=Path("analysis/steering/outputs/task_a_train_a520/intervention_results.json"))
    parser.add_argument("--output", type=Path, default=Path("analysis/steering/outputs/task_a_train_a520/intervention_summary.json"))
    parser.add_argument("--csv", type=Path, default=Path("analysis/steering/outputs/task_a_train_a520/intervention_summary.csv"))
