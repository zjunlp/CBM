...
from analysis.augment.domain_bridge import (
    build_rules_map,
    oracle_label,
    parse_candidate_rules_from_system_prompt,
    sample_redundant_triple,
)
from analysis.augment.format_rd_turn import (
    format_evidence_turn,
    format_evidence_turn_9b_post_lock,
    is_9b_rd_case,
)
from analysis.augment.prompt_parse import renumber_rd_turn_prompt, rebuild_active_evidence
